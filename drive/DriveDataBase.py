...
class DriveDataBase:
    ...
    def _escape_query(self, name):
        ...
        Without this, filenames with apostrophes cause: HttpError 400 Invalid Value
        """
    ...
    def _check_exists(self, name, parent_id, is_folder=False):
        ...
        try:
            #  escape name before putting in query
    ...
    def _upload_file(self, file_path, parent_id):
        ...
        try:
            ...
            if e.resp.status == 403:
                ...
                print(f"Parent folder not found for: {file_name} : {e}")
        ...
        try:
            ...
            for item in items:
                ...
                if os.path.isdir(item_path):
                    ...
                    if folder_id:
                        # count uploads from subfolders too
                        uploaded_count += self._upload_folder(item_path, folder_id)
